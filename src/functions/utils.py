...
def colorier_rang_favoris(row):

    couleurs = {1: "background-color: #FFF4B0;", # Or
                2: "background-color: #E6E6E6;", # Argent
                3: "background-color: #E6D6CF;"} # Bronze
